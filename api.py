...
class Overall(Resource):
    ...
    def post(self):
        ...
        ret =  subprocess.check_output("python3 main.py overall --budget {0} --budget_wage {1} --players {2} --gk {3} --defs {4} --mid {5} --att {6} --max_age {7}".format(
            args["budget"],
            args["budget_wage"],
            args["players"],
            args["gk"],
        ...
        final_list = []
        for i in res[:int(args['players'])-1]:#res[:10]:
...
class Potential(Resource):
    ...
    def post(self):
        ...
        ret =  subprocess.check_output("python3 main.py potential --budget {0} --budget_wage {1} --players {2} --gk {3} --defs {4} --mid {5} --att {6} --max_age {7} --max_overall {8}".format(
            args["budget"],
            args["budget_wage"],
            args["players"],
            args["gk"],
