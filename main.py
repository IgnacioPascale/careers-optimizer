...
def protocol(command: str, params):
    ...
    if command == 'overall':
        ...
        budget_wage = params.budget_wage if params.budget_wage else None
        players = params.players if params.players else None
        gk = params.gk if params.gk else None
        defs = params.defs if params.defs else None
        mid = params.mid if params.mid else None
        att = params.att if params.att else None
        max_age = params.max_age if params.max_age else None
    ...
    if command == 'potential':
        ...
        att = params.att if params.att else None
        max_age = params.max_age if params.max_age else None
        max_overall = params.max_overall if params.max_overall else None
